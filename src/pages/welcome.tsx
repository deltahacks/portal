...
const Welcome: NextPage = () => {
    return (
        <>
            ...
            <div className="font-main relative min-h-screen w-full overflow-x-hidden">
                <NavBar />
                <Background />
                <main className="px-7 py-14 sm:px-14 md:absolute md:w-10/12 md:pb-3 lg:pl-20 2xl:w-8/12 2xl:pt-20">
                    ...
                    <div className="pt-6 text-xl font-normal text-[#737373] sm:text-2xl lg:pt-8 lg:text-3xl lg:leading-tight 2xl:pt-10 2xl:text-4xl">
                        At DeltaHacks, we believe change comes from dreaming
                        big. Each year we enable over 800 students from across
                        North America, working hard over 36 hours, to bring
                        their big ideas to life. Unleash your creativity and
                        make something great, we{"'"}ll handle the rest! Make
                ...
                <footer className="absolute right-0 bottom-0 p-5">
                    <SocialButtons />
                </footer>
            </div>
        </>
