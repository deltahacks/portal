  ...
  return (
    <div className="mx-9 mt-5 flex flex-row items-center justify-between text-white md:mx-10 md:mt-8">
      ...
      <div className="flex items-center">
        ...
        <a className="mx-2 mr-8 font-sub text-sm md:hidden" href="#">
          <strong className="font-bold"> Home</strong>
        </a>
        <a className="mx-2 hidden font-sub text-sm lg:inline-block">
          Logged in as <strong className="font-bold"> Username</strong>
        </a>
        <button className="mx-2 rounded bg-[#4F14EE] py-2.5 px-5 font-sub text-sm font-bold md:px-7">
          Sign out
        </button>
      </div>
    </div>
