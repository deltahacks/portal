                            ...
                            <div className="flex w-7/12 flex-col gap-3">
                                ...
                                <div className="h-64 overflow-y-scroll break-words rounded border border-slate-300 p-6">
                                    ...
                                    <div>
                                        <div className="mt-5 mb-3 font-bold">
                                            If you had the ability to change
                                    ...
                                    <div>
                                        <div className="mt-5 mb-3 font-bold">
                                            What is a project you hope to
                                            undertake in the future? And why not
                                    ...
                                    <div>
                                        <div className="mt-5 mb-3 font-bold">
                                            If you could only speak in sentences
                                            from the script of one movie, which
                                            movie would it be and why?This
                                ...
                                <div className="h-40 overflow-y-scroll break-words rounded border border-slate-300 p-6">
                                    ...
                                    <div className="mt-5">
                                        ...
                                        {applicant.tshirtSize}
                                    </div>
                                    <div>
                                        <strong>Hacker Type: </strong>{" "}
                                        {applicant.hackerType}
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                        ...
                                        <p>
                                            &emsp;<b>Name:</b>{" "}
                                            {applicant.emergencyContactInfo
                                                .firstName || "N/A"}
                                            {applicant.emergencyContactInfo
                                                .lastName || "N/A"}
                                        </p>
